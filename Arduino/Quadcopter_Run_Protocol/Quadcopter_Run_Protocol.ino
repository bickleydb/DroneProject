...
void forward(int val){
  pitServ.writeMicroseconds(val);
}
/*
void forward(){
  pitServ.writeMicroseconds(PIT60); //PIT60
}*/
...
void strafeL(int val){
 rollServ.writeMicroseconds(val);
}
/*void strafeL(){
 rollServ.writeMicroseconds(ROLL40);
}*/

void strafeR(int val){
 rollServ.writeMicroseconds(val);
}
/*void strafeR(){
...
void land(){
  //added
// thrServ.writeMicroseconds(THR40);
// yawServ.writeMicroseconds(YAW40);
// pitServ.writeMicroseconds(PIT40);
// rollServ.writeMicroseconds(ROLL40);
  //end added
