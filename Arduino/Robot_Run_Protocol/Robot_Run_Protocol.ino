...
void motorRun(int setting, int modifier) 
{
  switch (setting)
  {
    ...
    case 1:
      while ((encoderLPos<=modifier)&&(encoderRPos<=modifier))
      {
        ...
        else if(encoderLPos-2>=encoderRPos)
        {
          digitalWrite(in1, HIGH);
          digitalWrite(in2, LOW);
          digitalWrite(in3, HIGH);
        ...
        else if(encoderLPos<encoderRPos-2)
        {
          digitalWrite(in1, HIGH);
          digitalWrite(in2, LOW);
          digitalWrite(in3, HIGH);
      ...
      break;
    case 2:
      while (encoderLPos<=(modifier/90)*15 && encoderRPos<=(modifier/90)*15)
      {
       if(encoderLPos==encoderRPos)
       { 
        digitalWrite(in1, HIGH);
